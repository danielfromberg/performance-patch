...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ -77.235477109269482, -12.499987900257111, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.537915999999996, 267.448278665542603, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 17.141402759600055, 2028.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 110.933054811246251, 2087.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3554.0, 221.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2966.0, 110.0, 83.0, 22.0 ],
					"text" : "scale 0. 1. 0 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.0, 1435.936555395252071, 55.0, 35.0 ],
					"text" : "0 769 769"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 282.266668081283569, 228.074273020029068, 81.466663837432861, 17.918160140514374 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 16.133324444293976, 199.519989013671875, 57.599853515625 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 670.964250546129733, 1023.133332967758179, 214.0, 118.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1265.363612044259298, 102.33333283662796, 164.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1235.866670370101929, -16.800009727478027, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal", "" ],
					"patching_rect" : [ 364.89999595284462, 846.166645109653473, 63.333331406116486, 54.399979472160339 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1110.916667687892868, 76.999998033046722, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 874.783332288265456, 51.566628575325012, 33.0, 22.0 ],
					"text" : "- 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1138.116667687893141, -27.800009727478027, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 769.479166666666629, "ms" ],
						"loopstart" : [ 0.0, "ms" ],
						"mode" : "extremestretch",
						"originallength" : [ 15.582068769022698, "ticks" ],
						"originaltempo" : 0.032462643616479,
						"phase" : [ 0.0, "ticks" ],
						"pitchcorrection" : 0,
						"quality" : "better",
						"timestretch" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 226.033353090286255, 50.0, 22.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.141402759600055, 2056.0, 42.0, 22.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.537915999999996, 151.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 883.86667013168335, 184.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 591.766665875911713, 184.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.940412622344638, 142.233347356319427, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.537915999999996, 184.0, 150.0, 22.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-81" : [ "live.gain~[42]", "live.gain~", 0 ],
			"obj-444" : [ "live.menu[5]", "live.menu", 0 ],
			"obj-167" : [ "live.gain~", "Gain", 0 ],
			"parameterbanks" : 			{
